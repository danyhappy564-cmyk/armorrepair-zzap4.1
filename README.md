...
> **원작: RaidArmorRepair 제작자 (디스코드 배포)** — 원본 배포 폴더:
...
> 원본 디스코드 설명에는 "현재는 최대내구도가 안 깎인다"고 되어 있었지만,
...
아래 항목들은 제가 **디스코드 설명과 상식선에서 재구성한 값**이며, 원본과 미묘하게 다를 수 있습니다.
